...
app.layout = dbc.Container(fluid=True, children=[
    ...
    dbc.Button("‹", id="prev-page", className="page-nav-btn page-nav-left", title="Trang trước",
               style={"position":"fixed","top":"50%","left":"16px","zIndex":9999}),
    dbc.Button("›", id="next-page", className="page-nav-btn page-nav-right", title="Trang sau",
